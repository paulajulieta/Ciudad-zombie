...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 70, 410, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 90, 410, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 755,155,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 350,390,15,30,1),
    new Obstaculo('imagenes/planta1.jpg', 855,80,30,30,1),
  ],
...
Juego.dibujar = function() {
  ...
  /* Completar */ //completaod
  // Se recorren los obstaculos de la carretera pintandolos . //3/
  ...
  for (var i = 0; i < this.jugador.vidas; i++) {
    var x = tamanio * i
    Dibujante.dibujarRectangulo('red', x, 0, tamanio, 13);
  }
...
Es decir, que no haya obstaculos que se interpongan. De ser asi, no podra moverse */ // 3/4
Juego.chequearColisiones = function(x, y) {
  var puedeMoverse = true
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {

      /*COMPLETAR, obstaculo debe chocar al jugador*/ //si chocan llamar a metodo obstaculo que quite vidas al jugador
...
Juego.dibujarFondo = function() {
  ...
  if (this.terminoJuego()) {
    Dibujante.dibujarImagen('imagenes/gameOver.png', 0, 5, this.anchoCanvas, this.altoCanvas);
    document.getElementById('reiniciar').style.visibility = 'visible';
  }

  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
  else if (this.ganoJuego()) {
    Dibujante.dibujarImagen('imagenes/Splash1.jpg', 190, 113, 500, 203);
    document.getElementById('reiniciar').style.visibility = 'visible';
  } else {
